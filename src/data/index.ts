...
export const FAQS = [
  {
    ...
    answer: "네, 크리에이터들의 원활한 레퍼런스 분석과 벤치마킹을 위해 원본 해상도(HD) 그대로 클린하게 비디오 소스 분석 및 추출을 지원합니다."
  },
  {
    id: "faq-2",
    question: "아이폰이나 안드로이드 스마트폰에서도 사용할 수 있나요?",
    answer: "물론입니다. 모바일 환경에서의 즉각적인 숏폼 트렌드 분석을 위해 아이폰(iOS) 사파리, 안드로이드 크롬 등 스마트폰 기본 브라우저에서 완벽하게 호환됩니다. 릴스나 틱톡을 시청하다가 발견한 바이럴 마케팅 레퍼런스 비디오를 즉시 갤러리에 저장하고 기획에 활용해 보세요."
  },
  {
    id: "faq-3",
    question: "백업 시 화질 저하가 발생하나요?",
    answer: "아니요. 원본 업로더가 올린 최대 4K 초고화질 포맷을 압축 없이 그대로 추출합니다. 워터마크나 화질 열화 없는 클린 버전 비디오는 숏폼 마케터들이 프레임 단위의 컷 편집 호흡, 자막 위치, 시각적 후킹 등의 레퍼런스를 정밀 분석(Reverse Engineering)하는 데 필수적입니다."
  },
  {
    id: "faq-4",
    question: "사용 횟수 제한이나 요금이 있나요?",
    answer: "완전 무료이며 횟수 제한도 없습니다. 숏폼 크리에이터와 디지털 마케터분들이 자유롭게 글로벌 바이럴 트렌드를 모니터링하고 벤치마킹 데이터를 수집할 수 있도록 무제한 제공됩니다. 본 서비스는 하단의 최소한의 광고 수익만으로 유지되는 평생 무료 마케팅 툴입니다."
  }
];
