...
export const FAQS = [
  ...
  },
  {
    ...
    answer: "물론입니다. 모바일 환경에서의 즉각적인 숏폼 트렌드 분석을 위해 아이폰(iOS) 사파리, 안드로이드 크롬 등 스마트폰 기본 브라우저에서 완벽하게 호환됩니다. 별도의 전용 앱 설치 없이 도우인이나 샤오홍슈를 시청하다가 발견한 바이럴 마케팅 레퍼런스 비디오 링크를 복사하여 모바일 웹 브라우저에서 바로 입력하고 갤러리에 저장하여 기획에 활용할 수 있습니다."
  },
  {
    id: "faq-3",
