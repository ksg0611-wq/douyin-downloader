...
export const metadata: Metadata = {
  alternates: { canonical: "https://shortspack.com/privacy" },
};
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 dark:bg-[#060609] dark:text-zinc-100 font-sans flex flex-col transition-colors duration-300">
      ...
      <main className="flex-grow max-w-3xl w-full mx-auto px-4 py-12 md:py-20 z-10">
        <h1 className="text-3xl md:text-4xl font-black tracking-tight text-zinc-900 dark:text-white mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-4">
          개인정보처리방침
        </h1>

        <div className="space-y-8 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm md:text-base">
          <p>
            ShortsPack Pro(이하 '회사')은(는) 이용자의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호 등에 관한 법률" 및 "개인정보보호법"을 준수하고 있습니다. 회사는 개인정보처리방침을 통하여 이용자가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
          </p>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">1. 수집하는 개인정보 항목</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">2. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">3. 구글 애드센스(Google AdSense) 및 쿠키 사용에 대한 명시 (필수 항목)</h2>
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>이용자는 구글 광고 설정(<a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">https://adssettings.google.com</a>)을 방문하여 맞춤형 광고 게재를 차단할 수 있습니다.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">4. 개인정보의 보유 및 파기</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">5. 개인정보보호책임자 및 문의</h2>
            <p>
