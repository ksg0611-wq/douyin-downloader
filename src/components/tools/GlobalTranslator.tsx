      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight">
            🌐 다국어 제목/자막 번역 (Global Title Translator)
          </h2>
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 글로벌 바이럴 숏폼 트렌드 문법에 적합한 다국어(영어, 일본어, 베트남어) 영상 타이틀과 자막 번역을 지원합니다. 번역 대상 문구를 입력하면 단순히 단어를 매핑하는 수준을 넘어 국가별 트렌드 피드백과 소셜 노출에 최적화된 카피를 작성합니다.
          </p>
        </div>
      </div>
