      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight">
            📊 해시태그 트렌드 분석 (Hashtag Trend Analyzer)
          </h2>
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 중국 및 글로벌 숏폼 시장의 최근 트렌드 태그와 유입량, 경쟁지수를 인공지능을 통해 교차 분석합니다. 검색하고자 하는 핵심 카테고리나 연관 키워드를 바탕으로 해시태그 목록과 마케팅 최적화 추천 지표를 제공합니다.
          </p>
        </div>
      </div>
