      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight flex items-center gap-2">
            📱 숏폼 안전 영역 프리뷰어 (Short-form Safe Zone Previewer)
          ...
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 각 플랫폼별 기본 시스템 UI 요소(좋아요, 댓글 버튼 등)에 콘텐츠 텍스트나 자막이 가려지는 현상을 사전 방지합니다. 썸네일이나 영상을 업로드하면 틱톡, 인스타그램 릴스, 유튜브 쇼츠의 UI 레이아웃 가이드를 실시간 오버레이하여 유효 노출 범위를 테스트합니다.
          </p>
        </div>
      </div>
