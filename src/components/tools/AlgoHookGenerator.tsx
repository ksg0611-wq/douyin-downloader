      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight flex items-center gap-2">
            📢 CTA & 댓글 유도 멘트 생성기 (Algo CTA & Comment Generator)
          ...
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 시청자가 영상을 끝까지 시청한 뒤 저장, 공유, 댓글 작성 등 알고리즘 가점 요소를 직접 실천하도록 이끄는 아웃트로 멘트를 빌드합니다. 영상 주제를 입력하면 독자 반응을 유도하는 10종의 질문 멘트와 참여형 고정 댓글용 추천 템플릿을 자동으로 만듭니다.
          </p>
        </div>
      </div>
