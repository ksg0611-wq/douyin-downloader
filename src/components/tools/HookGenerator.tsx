      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight flex items-center gap-2">
            🪄 3초 후킹 대본 생성기 (3-Second Hook Generator)
          ...
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 시청자의 초반 이탈을 막기 위해 3초 이내에 시선을 사로잡는 강력한 인트로 후킹 대본을 자동 빌드합니다. 영상의 대강의 주제를 입력하면 감정 자극, 호기심 유도, 통계 기반 등 검증된 3가지 타입의 후크 카피를 도출합니다.
          </p>
        </div>
      </div>
