      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight">
            🧮 크리에이터 예상 수익 계산기 (Revenue Simulator)
          </h2>
          <p className="text-xs text-zinc-650 dark:text-zinc-400 mt-1">
            본 도구는 유튜브 쇼츠, 인스타그램 릴스 등 숏폼 조회수와 채널의 카테고리를 기준으로 예상되는 광고 수익 및 브랜드 제안 단가를 시뮬레이션합니다. 조회수 구간과 제작 테마를 입력하면 업계 평균 단가 가중치를 대입하여 발생 가능한 크리에이터 비즈니스 가치 기대액을 도출합니다.
          </p>
        </div>
      </div>
